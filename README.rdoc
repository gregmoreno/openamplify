...
Settings can be overriden by the client
...
=== Usage
  ...
  analysis = client.amplify_this(:input_text => text)
  puts analysis  # default as xml

Some helpers for your convenience.

  client.analyze_text(text)
  client.analyze_url('http://gregmoreno.ca')
